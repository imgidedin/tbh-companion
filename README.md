...
- Se o jogo atualizar e a leitura falhar ("Leitura do log falhou" no log), rode o Il2CppDumper de novo e atualize os RVAs/offsets em `src/main.cpp` (constantes `kLogManager*`/`kLogData*`).
